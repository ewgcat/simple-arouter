...
public class ParameterFactory {
    ...
    private ParameterFactory(Builder builder) {
        ...
        method = MethodSpec.methodBuilder(com.lishuaihua.arouter_compiler.utils.ProcessorConfig.PARAMETER_METHOD_NAME)
    ...
    public void addFirstStatement() {
        method.addStatement("$T t = ($T) " + com.lishuaihua.arouter_compiler.utils.ProcessorConfig.PARAMETER_NAME, className, className);
    }
